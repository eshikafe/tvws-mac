...
const ECMA392_FC_ACK_POLICY_NO_ACK: u16 = 0x0000;
const ECMA392_FC_ACK_POLICY_IMM_ACK: u16 = 0x0008;
const ECMA392_FC_ACK_POLICY_B_ACK: u16 = 0x0010;
const ECMA392_FC_ACK_POLICY_B_ACK_REQ: u16 = 0x0018;
